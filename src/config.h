...
#define FAIRCONF_ACCESS_TRACELOCK 1 // Trace des verrouillages/déverrouillages
...
#define FAIRCONF_THROUGHPUT_TIME      1000 // Fenêtre de temps de moyennage (en ms)
#define FAIRCONF_THROUGHPUT_PRECISION 100  // Nombre de divisions de cette fenêtre
...
/// Valeurs par défaut
#define FAIRCONF_SCHEDULER_MAXCONNECTIONS     512 // Nombre maximum de connexions (= état) par utilisateur par défaut
#define FAIRCONF_SCHEDULER_MAXINPUTIFACE      32  // Nombre maximum d'interfaces d'entrées
...
#define FAIRCONF_SCHEDULER_MOREMEMBERSTATS  1 // Compte également les débits demandés et perdus de chaque adhérent, à titre informatif
